...
import { LifeTime } from './interfaces';
...
describe('resolve()', () => {
  ...
  it('should resolve value if registered with InjectionToken', () => {
    ...
    expect(concreteFactory instanceof ConcreteFactory).toBeTruthy();
  });
  ...
  describe('LifeTime', () => {
    ...
    it('should resolve different instances if LifeTime was set to LifeTime.PerRequest in case of nested dependencies', () => {
        ...
        expect(instance1.b).toEqual(instance2.b);
    });
  ...
  describe('Errors', () => {
    ...
    it('should resolve container instance when injected into class Literal', () => {
        ...
        expect(actual.a).toBeTruthy();
        expect(actual.a).toEqual(container);
    });
  });
  ...
  describe('Hierarchial', () => {
    it(`should start looking up dependencies by starting from the container it's first entity was resolved from`, () => {
        ...
        expect(a.b.c).toBeTruthy(C); // to.be.instanceof
    });
    ...
    it(`should start looking up dependencies by starting from the container it's first entity was resolved from`, () => {
        ...
        expect(a.b.c).toBeTruthy(C); // .to.be.instanceof(C);
        expect(a.b.c.d).toBeTruthy(D); // .to.be.instanceof(C);
    });
  });
  ...
  describe('createChild()', () => {
      it('should create child container', () => {
          ...
          expect(childContainer.parent).toEqual(container);
      });
  });
